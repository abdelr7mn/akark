...
//
//     _favorites = _properties.where((p) {
//       return favoriteIds.contains(p.id.toString());
//     }).toList();
//
...
//     final favoriteIds = prefs.getStringList('favorites') ?? [];
//
//     if (favoriteIds.contains(propertyId.toString())) {
//       favoriteIds.remove(propertyId.toString());
//       _favorites.removeWhere((p) => p.id == propertyId);
//     } else {
//       favoriteIds.add(propertyId.toString());
